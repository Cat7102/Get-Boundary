...
class Image_manipulate(object):
    ...
    def gray(self):
        ...
        cv2.imencode(self.path[-4:], gray)[1].tofile(os.path.join(os.path.dirname(self.path),'灰化图片'+self.path[-4:]))
        graypath=os.path.join(os.path.dirname(self.path),'灰化图片'+self.path[-4:])
    ...
    def blur(self,value,blurnum1,blurnum2,blurnum3):
        ...
        cv2.imencode(self.path[-4:], blur_img)[1].tofile(os.path.join(os.path.dirname(self.path), '模糊图片' + self.path[-4:]))
        blur_path = os.path.join(os.path.dirname(self.path), '模糊图片' + self.path[-4:])
    ...
    def binary(self,blacknum):
        ...
        cv2.imencode(self.path[-4:], thresh)[1].tofile(
            os.path.join(os.path.dirname(self.path), '黑白图片' + self.path[-4:]))
        thresh_path = os.path.join(os.path.dirname(self.path), '黑白图片' + self.path[-4:])
        thresh_path=os.path.abspath(thresh_path)
        return thresh_path
    def openandclose(self,value,kernel1,kernel2):
        kernel=np.ones((int(kernel1),int(kernel2)),np.uint8)
        if value==1:
            opened=cv2.morphologyEx(self.image,cv2.MORPH_OPEN,kernel)
            cv2.imencode(self.path[-4:], opened)[1].tofile(
                os.path.join(os.path.dirname(self.path), '开运算图片' + self.path[-4:]))
            open_path = os.path.join(os.path.dirname(self.path), '开运算图片' + self.path[-4:])
        ...
        if value==2:
            ...
            cv2.imencode(self.path[-4:], closed)[1].tofile(
                os.path.join(os.path.dirname(self.path), '闭运算图片' + self.path[-4:]))
            closed_path = os.path.join(os.path.dirname(self.path), '闭运算图片' + self.path[-4:])
            path=os.path.abspath(closed_path)
        return path
    def erode_dilate(self,value,kernel1,kernel2,iteration):
        kernel = np.ones((int(kernel1), int(kernel2)), np.uint8)
        iteration=int(iteration)
        if value==1:
            erosion=cv2.erode(self.image,kernel,iterations=iteration)
            cv2.imencode(self.path[-4:], erosion)[1].tofile(
                os.path.join(os.path.dirname(self.path), '腐蚀处理图片' + self.path[-4:]))
            erode_path = os.path.join(os.path.dirname(self.path), '腐蚀处理图片' + self.path[-4:])
        ...
        if value==2:
            ...
            cv2.imencode(self.path[-4:], dilation)[1].tofile(
                os.path.join(os.path.dirname(self.path), '膨胀处理图片' + self.path[-4:]))
            dilate_path = os.path.join(os.path.dirname(self.path), '膨胀处理图片' + self.path[-4:])
    ...
    def brim_draw(self,dot,index,color,width):
        ...
        cv2.imencode(self.path[-4:], drawcontours)[1].tofile(
            os.path.join(os.path.dirname(self.path), '轮廓图片' + self.path[-4:]))
        brim_path = os.path.join(os.path.dirname(self.path), '轮廓图片' + self.path[-4:])
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 270, 397))
        self.page.setObjectName("page")
        self.frame = QtWidgets.QFrame(self.page)
        self.frame.setGeometry(QtCore.QRect(10, 0, 261, 41))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 270, 397))
        self.page_2.setObjectName("page_2")
        self.frame_3 = QtWidgets.QFrame(self.page_2)
        self.frame_3.setGeometry(QtCore.QRect(0, 0, 271, 171))
        self.frame_3.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_3.setObjectName("frame_3")
        self.radioButton = QtWidgets.QRadioButton(self.frame_3)
        self.radioButton.setGeometry(QtCore.QRect(80, 70, 81, 16))
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtWidgets.QRadioButton(self.frame_3)
        self.radioButton_2.setGeometry(QtCore.QRect(160, 70, 81, 16))
        self.radioButton_2.setObjectName("radioButton_2")
        self.radioButton_3 = QtWidgets.QRadioButton(self.frame_3)
        self.radioButton_3.setGeometry(QtCore.QRect(80, 90, 81, 16))
        self.radioButton_3.setObjectName("radioButton_3")
        self.label_4 = QtWidgets.QLabel(self.frame_3)
        self.label_4.setGeometry(QtCore.QRect(10, 0, 231, 31))
        self.label_4.setObjectName("label_4")
        self.pushButton_4 = QtWidgets.QPushButton(self.frame_3)
        self.pushButton_4.setGeometry(QtCore.QRect(160, 140, 75, 23))
        self.pushButton_4.setObjectName("pushButton_4")
        self.radioButton_4 = QtWidgets.QRadioButton(self.frame_3)
        self.radioButton_4.setGeometry(QtCore.QRect(160, 90, 81, 16))
        self.radioButton_4.setObjectName("radioButton_4")
        self.pushButton_3 = QtWidgets.QPushButton(self.frame_3)
        self.pushButton_3.setGeometry(QtCore.QRect(170, 30, 75, 23))
        self.pushButton_3.setObjectName("pushButton_3")
        self.label_5 = QtWidgets.QLabel(self.frame_3)
        self.label_5.setGeometry(QtCore.QRect(10, 70, 61, 16))
        self.label_5.setObjectName("label_5")
        self.frame_11 = QtWidgets.QFrame(self.frame_3)
        self.frame_11.setGeometry(QtCore.QRect(20, 110, 131, 61))
        ...
        self.label_7.setGeometry(QtCore.QRect(0, 10, 101, 16))
        ...
        self.frame_12.setGeometry(QtCore.QRect(20, 110, 131, 61))
        ...
        self.frame_13.setGeometry(QtCore.QRect(20, 110, 131, 61))
        ...
        self.label_21.setGeometry(QtCore.QRect(40, 30, 71, 21))
        self.label_21.setObjectName("label_21")
        self.lineEdit_12 = QtWidgets.QLineEdit(self.frame_3)
        self.lineEdit_12.setGeometry(QtCore.QRect(120, 30, 41, 21))
        self.lineEdit_12.setObjectName("lineEdit_12")
        self.toolBox.addItem(self.page_2, "")
        self.page_3 = QtWidgets.QWidget()
        self.page_3.setGeometry(QtCore.QRect(0, 0, 270, 397))
        self.page_3.setObjectName("page_3")
        self.frame_4 = QtWidgets.QFrame(self.page_3)
        self.frame_4.setGeometry(QtCore.QRect(0, 0, 271, 221))
        self.frame_4.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frame_4.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_4.setObjectName("frame_4")
        self.label_16 = QtWidgets.QLabel(self.frame_4)
        self.label_16.setGeometry(QtCore.QRect(10, 50, 151, 21))
        ...
        self.lineEdit_9.setGeometry(QtCore.QRect(150, 10, 31, 20))
        ...
        self.label_18.setGeometry(QtCore.QRect(130, 10, 21, 21))
        self.label_18.setAlignment(QtCore.Qt.AlignCenter)
        self.label_18.setObjectName("label_18")
        self.lineEdit_10 = QtWidgets.QLineEdit(self.frame_4)
        self.lineEdit_10.setGeometry(QtCore.QRect(100, 10, 31, 20))
        self.lineEdit_10.setObjectName("lineEdit_10")
        self.label_19 = QtWidgets.QLabel(self.frame_4)
        self.label_19.setGeometry(QtCore.QRect(10, 80, 151, 21))
        self.label_19.setObjectName("label_19")
        self.pushButton_8 = QtWidgets.QPushButton(self.frame_4)
        self.pushButton_8.setGeometry(QtCore.QRect(170, 80, 75, 23))
        self.pushButton_8.setObjectName("pushButton_8")
        self.toolBox.addItem(self.page_3, "")
        self.page_4 = QtWidgets.QWidget()
        self.page_4.setGeometry(QtCore.QRect(0, 0, 270, 397))
        self.page_4.setObjectName("page_4")
        self.frame_2 = QtWidgets.QFrame(self.page_4)
        self.frame_2.setGeometry(QtCore.QRect(0, 0, 271, 281))
        ...
        self.label_9.setGeometry(QtCore.QRect(60, 90, 61, 21))
        self.label_9.setObjectName("label_9")
        self.lineEdit_3 = QtWidgets.QLineEdit(self.frame_2)
        self.lineEdit_3.setGeometry(QtCore.QRect(120, 90, 31, 21))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.pushButton_5 = QtWidgets.QPushButton(self.frame_2)
        self.pushButton_5.setGeometry(QtCore.QRect(160, 90, 75, 23))
        self.pushButton_5.setObjectName("pushButton_5")
        self.label_10 = QtWidgets.QLabel(self.frame_2)
        self.label_10.setGeometry(QtCore.QRect(10, 130, 231, 16))
        self.label_10.setObjectName("label_10")
        self.lineEdit_4 = QtWidgets.QLineEdit(self.frame_2)
        self.lineEdit_4.setGeometry(QtCore.QRect(150, 60, 31, 20))
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.lineEdit_5 = QtWidgets.QLineEdit(self.frame_2)
        self.lineEdit_5.setGeometry(QtCore.QRect(100, 60, 31, 20))
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.label_11 = QtWidgets.QLabel(self.frame_2)
        self.label_11.setGeometry(QtCore.QRect(130, 60, 21, 21))
        self.label_11.setAlignment(QtCore.Qt.AlignCenter)
        self.label_11.setObjectName("label_11")
        self.label_12 = QtWidgets.QLabel(self.frame_2)
        self.label_12.setGeometry(QtCore.QRect(60, 40, 101, 16))
        self.label_12.setObjectName("label_12")
        self.lineEdit_6 = QtWidgets.QLineEdit(self.frame_2)
        self.lineEdit_6.setGeometry(QtCore.QRect(150, 180, 31, 20))
        self.lineEdit_6.setObjectName("lineEdit_6")
        self.lineEdit_7 = QtWidgets.QLineEdit(self.frame_2)
        self.lineEdit_7.setGeometry(QtCore.QRect(100, 180, 31, 20))
        self.lineEdit_7.setObjectName("lineEdit_7")
        self.label_13 = QtWidgets.QLabel(self.frame_2)
        self.label_13.setGeometry(QtCore.QRect(130, 180, 21, 21))
        ...
        self.lineEdit_8.setGeometry(QtCore.QRect(120, 210, 31, 21))
        self.lineEdit_8.setObjectName("lineEdit_8")
        self.label_15 = QtWidgets.QLabel(self.frame_2)
        self.label_15.setGeometry(QtCore.QRect(60, 210, 61, 21))
        self.label_15.setObjectName("label_15")
        self.pushButton_6 = QtWidgets.QPushButton(self.frame_2)
        self.pushButton_6.setGeometry(QtCore.QRect(160, 210, 75, 23))
        self.pushButton_6.setObjectName("pushButton_6")
        self.label_3 = QtWidgets.QLabel(self.frame_2)
        self.label_3.setGeometry(QtCore.QRect(0, 250, 251, 31))
        self.label_3.setScaledContents(False)
        self.label_3.setAlignment(QtCore.Qt.AlignCenter)
        self.label_3.setObjectName("label_3")
        self.toolBox.addItem(self.page_4, "")
        self.page_5 = QtWidgets.QWidget()
        self.page_5.setGeometry(QtCore.QRect(0, 0, 270, 397))
        self.page_5.setObjectName("page_5")
        self.frame_5 = QtWidgets.QFrame(self.page_5)
        self.frame_5.setGeometry(QtCore.QRect(0, 0, 271, 421))
        self.frame_5.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frame_5.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frame_5.setObjectName("frame_5")
        self.frame_6 = QtWidgets.QFrame(self.frame_5)
        self.frame_6.setGeometry(QtCore.QRect(10, 10, 251, 91))
        ...
        self.radioButton_5.setGeometry(QtCore.QRect(10, 30, 91, 16))
        self.radioButton_5.setObjectName("radioButton_5")
        self.radioButton_6 = QtWidgets.QRadioButton(self.frame_6)
        self.radioButton_6.setGeometry(QtCore.QRect(120, 30, 111, 16))
        self.radioButton_6.setObjectName("radioButton_6")
        self.radioButton_7 = QtWidgets.QRadioButton(self.frame_6)
        self.radioButton_7.setGeometry(QtCore.QRect(10, 60, 101, 16))
        self.radioButton_7.setObjectName("radioButton_7")
        self.radioButton_8 = QtWidgets.QRadioButton(self.frame_6)
        self.radioButton_8.setGeometry(QtCore.QRect(120, 60, 121, 16))
        self.radioButton_8.setObjectName("radioButton_8")
        self.frame_7 = QtWidgets.QFrame(self.frame_5)
        self.frame_7.setGeometry(QtCore.QRect(10, 110, 251, 91))
        ...
        self.radioButton_13.setGeometry(QtCore.QRect(10, 30, 161, 16))
        self.radioButton_13.setObjectName("radioButton_13")
        self.radioButton_14 = QtWidgets.QRadioButton(self.frame_7)
        self.radioButton_14.setGeometry(QtCore.QRect(10, 60, 241, 16))
        self.radioButton_14.setObjectName("radioButton_14")
        self.frame_8 = QtWidgets.QFrame(self.frame_5)
        self.frame_8.setGeometry(QtCore.QRect(10, 240, 251, 51))
        ...
        self.label_26.setGeometry(QtCore.QRect(130, 20, 61, 21))
        self.label_26.setObjectName("label_26")
        self.label_27 = QtWidgets.QLabel(self.frame_9)
        self.label_27.setGeometry(QtCore.QRect(10, 20, 61, 21))
        self.label_27.setObjectName("label_27")
        self.comboBox = QtWidgets.QComboBox(self.frame_9)
        self.comboBox.setGeometry(QtCore.QRect(80, 20, 41, 22))
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(200, 20, 41, 22))
        self.comboBox_2.setObjectName("comboBox_2")
        self.pushButton_10 = QtWidgets.QPushButton(self.frame_5)
        self.pushButton_10.setGeometry(QtCore.QRect(100, 370, 75, 23))
        self.pushButton_10.setObjectName("pushButton_10")
        self.toolBox.addItem(self.page_5, "")
        self.page_6 = QtWidgets.QWidget()
        self.page_6.setObjectName("page_6")
        self.frame_10 = QtWidgets.QFrame(self.page_6)
        self.frame_10.setGeometry(QtCore.QRect(10, 0, 251, 381))
        self.frame_10.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_10.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_10.setObjectName("frame_10")
        self.label_25 = QtWidgets.QLabel(self.frame_10)
        self.label_25.setGeometry(QtCore.QRect(40, 100, 171, 20))
        self.label_25.setAlignment(QtCore.Qt.AlignCenter)
        self.label_25.setObjectName("label_25")
        self.frame_14 = QtWidgets.QFrame(self.frame_10)
        self.frame_14.setGeometry(QtCore.QRect(0, 10, 251, 41))
        ...
        self.label_28.setGeometry(QtCore.QRect(10, 10, 61, 21))
        self.label_28.setObjectName("label_28")
        self.radioButton_9 = QtWidgets.QRadioButton(self.frame_14)
        self.radioButton_9.setGeometry(QtCore.QRect(80, 10, 51, 21))
        self.radioButton_9.setObjectName("radioButton_9")
        self.radioButton_10 = QtWidgets.QRadioButton(self.frame_14)
        self.radioButton_10.setGeometry(QtCore.QRect(160, 10, 51, 21))
        self.radioButton_10.setObjectName("radioButton_10")
        self.pushButton_12 = QtWidgets.QPushButton(self.frame_10)
        self.pushButton_12.setGeometry(QtCore.QRect(80, 70, 75, 23))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_2.setText(_translate("Dialog", "灰化"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("Dialog", "第一步：灰化处理"))
        self.radioButton.setText(_translate("Dialog", "平均模糊"))
        self.radioButton_2.setText(_translate("Dialog", "高斯模糊"))
        self.radioButton_3.setText(_translate("Dialog", "中值模糊"))
        self.label_4.setText(_translate("Dialog", "没有固定先后顺序，一切按照最佳效果执行"))
        self.pushButton_4.setText(_translate("Dialog", "模糊"))
        self.radioButton_4.setText(_translate("Dialog", "双边滤波"))
        self.pushButton_3.setText(_translate("Dialog", "二值化"))
        self.label_5.setText(_translate("Dialog", "模糊种类："))
        self.lineEdit.setText(_translate("Dialog", "9"))
        self.lineEdit_2.setText(_translate("Dialog", "9"))
        self.label_7.setText(_translate("Dialog", "低通滤波器大小："))
        self.label_6.setText(_translate("Dialog", "X"))
        self.lineEdit_15.setText(_translate("Dialog", "9"))
        self.label_31.setText(_translate("Dialog", "中值模糊大小："))
        self.lineEdit_17.setText(_translate("Dialog", "9"))
        self.label_33.setText(_translate("Dialog", "双边模糊数值："))
        ...
        self.label_21.setText(_translate("Dialog", "二值化像素："))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("Dialog", "第二步：二值化或模糊"))
        self.label_16.setText(_translate("Dialog", "开运算：适用于图像去噪点"))
        self.label_17.setText(_translate("Dialog", "卷积核心大小："))
        self.lineEdit_9.setText(_translate("Dialog", "9"))
        self.pushButton_7.setText(_translate("Dialog", "开运算"))
        self.label_18.setText(_translate("Dialog", "X"))
        self.lineEdit_10.setText(_translate("Dialog", "9"))
        self.label_19.setText(_translate("Dialog", "闭运算：用于填充图像内部"))
        self.pushButton_8.setText(_translate("Dialog", "闭运算"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("Dialog", "第三步：图像开闭运算（非必要）"))
        self.label_8.setText(_translate("Dialog", "腐蚀（去除噪点）"))
        self.label_9.setText(_translate("Dialog", "重复次数："))
        self.lineEdit_3.setText(_translate("Dialog", "4"))
        self.pushButton_5.setText(_translate("Dialog", "腐蚀"))
        self.label_10.setText(_translate("Dialog", "膨胀（还原边界）"))
        self.lineEdit_4.setText(_translate("Dialog", "5"))
        self.lineEdit_5.setText(_translate("Dialog", "5"))
        self.label_11.setText(_translate("Dialog", "X"))
        self.label_12.setText(_translate("Dialog", "卷积核心大小："))
        ...
        self.label_14.setText(_translate("Dialog", "卷积核心大小："))
        self.lineEdit_8.setText(_translate("Dialog", "4"))
        self.label_15.setText(_translate("Dialog", "重复次数："))
        self.pushButton_6.setText(_translate("Dialog", "腐蚀"))
        self.label_3.setText(_translate("Dialog", "（一般建议采用同一个卷积核心）"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_4), _translate("Dialog", "第四步：腐蚀和膨胀（非必要）"))
        self.label_20.setText(_translate("Dialog", "轮廓检索模式："))
        self.radioButton_5.setText(_translate("Dialog", "只检测外轮廓"))
        self.radioButton_6.setText(_translate("Dialog", "不建立等级关系"))
        self.radioButton_7.setText(_translate("Dialog", "两个等级轮廓"))
        self.radioButton_8.setText(_translate("Dialog", "等级树结构轮廓"))
        self.label_22.setText(_translate("Dialog", "轮廓近似方法："))
        self.radioButton_13.setText(_translate("Dialog", "存储所有的轮廓点"))
        self.radioButton_14.setText(_translate("Dialog", "压缩各方向元素，只保留该方向终点坐标"))
        self.label_24.setText(_translate("Dialog", "轮廓颜色："))
        self.radioButton_17.setText(_translate("Dialog", "红"))
        self.radioButton_18.setText(_translate("Dialog", "绿"))
        self.radioButton_19.setText(_translate("Dialog", "蓝"))
        self.pushButton_9.setText(_translate("Dialog", "Execute"))
        self.label_26.setText(_translate("Dialog", "轮廓选择："))
        self.label_27.setText(_translate("Dialog", "线条粗细："))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_5), _translate("Dialog", "第五步：取轮廓并与原图对比"))
        self.label_25.setText(_translate("Dialog", "百分数"))
        self.label_28.setText(_translate("Dialog", "固体颜色："))
        self.radioButton_9.setText(_translate("Dialog", "黑"))
        self.radioButton_10.setText(_translate("Dialog", "白"))
        self.pushButton_12.setText(_translate("Dialog", "Execute"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_6), _translate("Dialog", "取液相份数"))
    ...
    def openbutton(self):
        path = self.lineEdit_11.text()
        kernelnum1,kernelnum2=self.lineEdit_10.text(),self.lineEdit_9.text()
        open_=Image_manipulate(path)
        openpath=open_.openandclose(1,kernelnum1,kernelnum2)
    ...
    def closebutton(self):
        ...
        closepath=close_.openandclose(2,kernelnum1,kernelnum2)
    ...
    def erodebutton(self):
        path = self.lineEdit_11.text()
        kernelnum1, kernelnum2,iteration=self.lineEdit_5.text(),self.lineEdit_4.text(),self.lineEdit_3.text()
        erode=Image_manipulate(path)
        erodepath=erode.erode_dilate(1,kernelnum1,kernelnum2,iteration)
    ...
    def dilatebutton(self):
        path = self.lineEdit_11.text()
        kernelnum1, kernelnum2,iteration=self.lineEdit_7.text(),self.lineEdit_6.text(),self.lineEdit_8.text()
        dilate=Image_manipulate(path)
        dilatepath=dilate.erode_dilate(2,kernelnum1,kernelnum2,iteration)
    ...
    def analyze_button(self):
        ...
        if self.radioButton_9.isChecked():
            ...
            value=1
        per=analyze(path,value)
        self.label_25.setText("固体占比百分比为：{:.4f}%".format(per))
