...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 330, 614))
        ...
        self.page_4.setGeometry(QtCore.QRect(0, 0, 330, 614))
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 330, 614))
        ...
        self.page_5.setGeometry(QtCore.QRect(0, 0, 330, 614))
        ...
        self.page_6.setGeometry(QtCore.QRect(0, 0, 330, 614))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(_translate("Dialog", "模糊、滤波种类："))
        self.label_21.setText(_translate("Dialog", "二值化参数："))
        self.lineEdit_17.setText(_translate("Dialog", "9"))
        self.label_33.setText(_translate("Dialog", "参数："))
        ...
        self.label_7.setText(_translate("Dialog", "卷积核大小:"))
        self.label_6.setText(_translate("Dialog", "X"))
        self.lineEdit_15.setText(_translate("Dialog", "9"))
        self.label_31.setText(_translate("Dialog", "卷积核大小："))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("Dialog", "灰化、二值化、模糊滤波"))
        self.label_8.setText(_translate("Dialog", "腐蚀："))
        self.label_9.setText(_translate("Dialog", "次数："))
        self.lineEdit_3.setText(_translate("Dialog", "4"))
        self.pushButton_5.setText(_translate("Dialog", "腐蚀"))
        self.label_10.setText(_translate("Dialog", "膨胀："))
        self.lineEdit_5.setText(_translate("Dialog", "5"))
        self.label_12.setText(_translate("Dialog", "卷积核大小："))
        self.lineEdit_7.setText(_translate("Dialog", "5"))
        self.label_14.setText(_translate("Dialog", "卷积核大小："))
        self.lineEdit_8.setText(_translate("Dialog", "4"))
        self.label_15.setText(_translate("Dialog", "次数："))
        self.pushButton_6.setText(_translate("Dialog", "膨胀"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_4), _translate("Dialog", "腐蚀与膨胀"))
        self.label_16.setText(_translate("Dialog", "开运算：用于清楚噪点"))
        self.label_17.setText(_translate("Dialog", "卷积核大小："))
        self.pushButton_7.setText(_translate("Dialog", "开运算"))
        self.lineEdit_10.setText(_translate("Dialog", "9"))
        self.label_19.setText(_translate("Dialog", "闭运算：填充内部空洞"))
        self.pushButton_8.setText(_translate("Dialog", "闭运算"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("Dialog", "开运算与闭运算"))
        self.label_20.setText(_translate("Dialog", "轮廓检索模式："))
        self.radioButton_5.setText(_translate("Dialog", "仅外层轮廓"))
        self.radioButton_6.setText(_translate("Dialog", "无等级"))
        self.radioButton_7.setText(_translate("Dialog", "双层等级序列"))
        self.radioButton_8.setText(_translate("Dialog", "树状等级序列"))
        self.label_22.setText(_translate("Dialog", "轮廓点获取模式："))
        self.radioButton_13.setText(_translate("Dialog", "保存所有数据点"))
        self.radioButton_14.setText(_translate("Dialog", "仅保留起始点"))
        self.pushButton_10.setText(_translate("Dialog", "执行"))
        self.pushButton_9.setText(_translate("Dialog", "执行"))
        self.label_26.setText(_translate("Dialog", "轮廓编号："))
        self.label_27.setText(_translate("Dialog", "轮廓线宽："))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_5), _translate("Dialog", "获取轮廓"))
        self.label_28.setText(_translate("Dialog", "固体颜色："))
        self.radioButton_9.setText(_translate("Dialog", "黑色"))
        self.radioButton_10.setText(_translate("Dialog", "白色"))
        self.pushButton_12.setText(_translate("Dialog", "执行"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_6), _translate("Dialog", "获取液相份数"))
